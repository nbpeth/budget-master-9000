...
var _expenseService = __webpack_require__(15);
...
var _ExpenseTable = __webpack_require__(13);

var _ExpenseTable2 = _interopRequireDefault(_ExpenseTable);

var _CreateExpenseForm = __webpack_require__(11);

var _CreateExpenseForm2 = _interopRequireDefault(_CreateExpenseForm);

var _reducers = __webpack_require__(2);

var _reducers2 = _interopRequireDefault(_reducers);

var _WeeklySummaryWidget = __webpack_require__(14);

var _WeeklySummaryWidget2 = _interopRequireDefault(_WeeklySummaryWidget);
...
var CreateExpenseForm = function (_React$Component) {
	_inherits(CreateExpenseForm, _React$Component);

	function CreateExpenseForm(props) {
		_classCallCheck(this, CreateExpenseForm);

		return _possibleConstructorReturn(this, (CreateExpenseForm.__proto__ || Object.getPrototypeOf(CreateExpenseForm)).call(this, props));
	}

	_createClass(CreateExpenseForm, [{
		key: 'createExpense',
		value: function createExpense(data) {
			_expensesStore2.default.dispatch((0, _actions.createExpenseAction)(data));
		}
	}, {
		key: 'render',
		value: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement('input', { type: 'email', className: 'form-control', id: 'location', 'aria-describedby': 'emailHelp', placeholder: 'Location', s: true }),
						React.createElement('br', null),
						React.createElement('input', { type: 'number', className: 'form-control', id: 'cost', placeholder: 'Cost' }),
						React.createElement('br', null),
						React.createElement(
							'select',
						...
						React.createElement(
							...
							{ type: 'button', className: 'btn btn-primary', onClick: function onClick() {
									return _this2.createExpense(getFormData());
								} },
							'Submit'
						)
					)
...
exports.default = CreateExpenseForm;
...
var _Expense = __webpack_require__(12);
...
exports.default = WeeklySummaryWidget;
